 <?php
    ...
    if (
        ...
        $visite = new Visite();
        $visite =   $visite->getProchaineVisiteByGuide($guide->getIdUtilisateur()) ?? false;
    }
    ?>
         ...
         <main class="flex-1 flex flex-col h-full overflow-y-auto overflow-x-hidden">
             ...
             <div class="p-6 md:p-10 max-w-7xl mx-auto w-full flex flex-col gap-8">
                 ...
                 <div class="flex flex-col gap-2">
                     <h2 class="text-3xl md:text-4xl font-extrabold tracking-tight">Bonjour, <?= $guide->getNomUtilisateur() ?> !</h2>
                 ...
                 <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                     ...
                     <div class="bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark shadow-md p-5 flex flex-col gap-2">
                         ...
                         <p class="text-xl font-extrabold tracking-tight text-primary"><?php if ($visite) echo $visite->getDateheureVisite()->format('d/m/Y'); ?></p>
                         <p class="text-sm  font-extrabold tracking-tight text-primary"><?php if ($visite) echo "à  " . $visite->getDateheureVisite()->format('H:i'); ?></p>
                         <p class="text-sm font-semibold"><?php if ($visite) echo  $visite->getTitreVisite();
                     ...
                     <div class="bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark shadow-md p-5 flex flex-col gap-2">
                         ...
                         <p class="text-xl font-extrabold tracking-tight"><?= Visite::counterVisitesbyGuide($guide->getIdUtilisateur()) ?></p>
                     ...
                     <div class="bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark shadow-md p-5 flex flex-col gap-2">
                         ...
                         <p class="text-xl font-extrabold tracking-tight"><?= $guide->getNoteGuide() ?> / 5.0</p>
