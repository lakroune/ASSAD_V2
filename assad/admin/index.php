                ...
                <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div
                        ...
                        <div class="relative z-10">
                            ...
                            <p class="text-xs text-primary/80 mt-1 font-medium">
                                <?php

                                if (Animal::counterAnimaux() > 0) {
                                    $habitat = new Habitat();
                                    $habitat->habitatPulsFrequent();
                                    echo " Dans l'habitat :". $habitat->getNomHabitat() . " habitats";
                                }
                                ?>
                        </div>
                    </div>
                    ...
                    <!-- visite le plus frequent -->
                    <div
                        class="bg-surface-light dark:bg-surface-dark p-5 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col justify-between hover:border-blue-200 transition-colors group">
                        <div class="flex justify-between items-start mb-4">
                            <div
                                class="p-3 bg-blue-100 dark:bg-blue-900/20 rounded-lg text-blue-600 group-hover:bg-blue-500 group-hover:text-white transition-colors">
                                <span class="material-symbols-outlined text-2xl block"> public</span>
                            </div>
                        </div>
                        <div>
                            <p class="text-text-secondary-light dark:text-text-secondary-dark text-sm font-medium"> viste le plus frequent</p>
                            <h3 class="text-lg font-bold text-text-light dark:text-text-dark truncate"><?= $viste->getTitreVisite() ?>
                            </h3>
                            <p class="text-xs text-gray-400 mt-1">

                                <?php
                                if (Reservation::conuterReservationsByVisite($viste->getIdVisite()) > 0)
                                    echo "Dont " .   Reservation::conuterReservationsByVisite($viste->getIdVisite()) . " reservations";
                                ?>
                            </p>
                        </div>
                    </div>
